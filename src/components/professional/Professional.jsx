...
export default function Professional() {
  return (
    <section className={["professional_section", "layout_padding", styles.section].join(" ")}>
      <div className="container">
        <div className={["row", styles.row].join(" ")}>
          <div className="col-md-6">
            <div className="img-box">
              <img src={professionalImg} alt="" className={styles.img} />
            </div>
          </div>
          <div className="col-md-6 ">
            <div className="detail-box">
              ...
              <Link to="" className={styles.link}>Read More</Link>
            </div>
          </div>
        </div>
      </div>
